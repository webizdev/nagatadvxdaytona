...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden">
        <div class="p-6 border-b border-slate-700">
            <h3 class="font-bold text-lg text-white">Edit Kategori: {{ $category->name }}</h3>
        </div>
        ...
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="pt-4 text-xs text-slate-500 italic">
                * Menghapus atau mengubah parent kategori akan berdampak pada susunan hierarki sub-kategori di bawahnya.
            </div>
